...
import { handleHomePage, handleScheduler, handleRanking, handleTeams, handlePlayers, handleInformation, handlePrintResult, handleAIPredict } from '../controller/homeController'
...
const initWebRoute = (app) => {
    router.get('/', handleHomePage),
        ...
        router.get('/ranking', handleRanking),
        router.post('/result', handlePrintResult),
        router.get('/information', handleInformation),
        router.get('/aipredict', handleAIPredict)
